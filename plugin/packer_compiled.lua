...
_G.packer_plugins = {
  ...
  LeaderF = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/LeaderF",
  ...
  edge = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/edge",
  ...
  ["filetype.nvim"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/filetype.nvim",
  ...
  ["moonlight.nvim"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/moonlight.nvim",
  ...
  neon = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/neon",
  ...
  ["nvim-tabline"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/nvim-tabline",
  ...
  ["persisted.nvim"] = {
    ...
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/persisted.nvim",
